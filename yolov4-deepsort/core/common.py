...
#class to perform batch normailization
class BatchNormalization(tf.keras.layers.BatchNormalization):
    ...
    def call(self, x, training=False):
        ...
        #trainable is a attribute of class tf.keras.layers and denotes whether the layer should be trainable
        training = tf.logical_and(training, self.trainable)
        #super is to access methods of parrent class 
        #not sure why it is needed here.
        #call performs the feedforward computation
